                ...
                <div class="p-5">
                    ...
                    <div class="mb-4 rounded-lg overflow-hidden">
                        ...
                        <div class="relative cursor-pointer group" onclick="openFullscreen('<?php echo htmlspecialchars($record['media']); ?>', 'image')">
                            <img src="uploads/<?php echo htmlspecialchars($record['media']); ?>" alt="任务图片" class="w-full h-48 object-cover transition-transform duration-500 group-hover:scale-105">
